...
class Clase(models.Model): 
   ...
   profesor_a_cargo = models.ManyToManyField(Profesor, blank=True)
   ...
   unidad_tematica_o_tema = models.ManyToManyField(Contenido, blank=True)
   resultado_de_aprendizaje = models.ManyToManyField(ResultadoDeAprendizaje, blank=True)
