...
class Planificacion(models.Model): 
   ...
   condicion_aprobacion_directa = models.CharField(max_length=3000, null=True, blank=True)
   condicion_aprobacion_cursada = models.CharField(max_length=3000, null=True, blank=True)
