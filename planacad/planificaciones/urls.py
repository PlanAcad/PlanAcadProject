...
from planificaciones.funcionesDeVistas import viewProfesor, viewAsignatura, viewLogin,viewPlanificacion, viewDatosDescriptivos, viewFundamentacion,viewContenido
from . import views
...
urlpatterns = [
    ...
    path('planificacion/<int:id_planificacion>/unidades', viewContenido.ContenidoView, name='unidades'),
